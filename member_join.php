...
<div class="dataDiv">
  ...
  <p><strong>使用帳號</strong>:
    ...
    <span class="smalltext">請填入5~12字元內的小寫英文字母、數字、以及 _ 符號。</span></p>
    <p><strong>使用密碼</strong>:
      <input name="m_password" type="password" class="normaliput" id="m_password">
      <font color="#FF0000">*</font><br>
      <span class="smalltext">請填入5~12字元內的小寫英文字母、數字。</span></p>
      <p><strong>確認密碼</strong>:
        ...
        <p><strong>真實姓名</strong>:
          ...
          <p><strong>電子信箱</strong>:
            ...
            <font color="#FF0000">*</font></p>
            <p class="smalltext">請確認此信箱可使用，以便未來系統使用，如:補寄會員密碼信。</p>
            <p><strong>電 話</strong>:
